...
export interface PaymobSdk {
  ...
  /**
   * Whether the SDK lifts its card fields clear of the keyboard. Off does not remove the
   * floating "Done" pill, only the avoidance, which leaves the field being typed into hidden.
   */
